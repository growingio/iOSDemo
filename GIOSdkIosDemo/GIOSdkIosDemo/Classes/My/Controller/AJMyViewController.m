...
@interface AJMyViewController ()<AJMenuViewDelegate>
...
-(void) ShowOrderListPage:(long )vtid{
    ...
    [self.navigationController pushViewController:[[AJOrderListView alloc]initTagId:vtid ] animated:YES];
}

...
- (void)addButtonClick:(UIButton *)btn{
    //用户增加商品，打点统计
    NSLog(@"设置GrowingIO打点操作，PPL:{addGoods:1}，具体的打点方法，请对照文档：https://docs.growingio.com/docs/sdk-integration/ios-sdk/#setpeoplevariable");
    [Growing setPeopleVariable:@{@"addGoods":@1}];
...
- (void)cutButtonClick:(UIButton *)btn{
    //用户减少商品，打点统计
    NSLog(@"设置GrowingIO打点操作，PPL:{subGoods:1}，具体的打点方法，请对照文档：https://docs.growingio.com/docs/sdk-integration/ios-sdk/#setpeoplevariable");
    [Growing setPeopleVariable:@{@"subGoods":@1}];

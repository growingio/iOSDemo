...
//        }];
        ...
        [_specificsLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(_giveImageView.mas_bottom).offset(5);
            make.leading.equalTo(_nameLabel);
...
//        }];
        [_discountPriceView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            //make.centerY.equalTo(_specificsLabel).offset(3);
            make.leading.equalTo(self);
            //make.trailing.equalTo(_buyView);
//            make.trailing.equalTo(_specificsLabel).offset(4);
            make.top.equalTo(_specificsLabel.mas_bottom).offset(10);
            make.right.equalTo(_specificsLabel.mas_right).offset(50);
        }];
    }
    return self;
}

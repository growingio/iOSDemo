...
- (instancetype)initWithHeadData:(AJHomeHeadData *)headData{
    ...
    //替换icons  2018-10-25
    NSArray *images=@[@"icon_grid011",@"icon_grid022",@"icon_grid033",@"icon_grid044",@"icon_grid055",@"icon_grid066",@"icon_grid077",@"icon_grid088"];
    iconImages=[images mutableCopy];
    
    //NSLog(@"替换后的图片路径：%@",iconImages);
